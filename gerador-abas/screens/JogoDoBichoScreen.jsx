...
export default function JogoDoBichoScreen() {
  ...
  function sortearAnimal() {
    ...
    setAnimalSorteado(sorteado);
  }

  return (
    <View style={styles.container}>
      <Text style={styles.titulo}>Gerador de Jogos Jogo do Bicho</Text>
      ...
      {animalSorteado && (
        <Card style={styles.card}>
          <Card.Content>
            <Text style={styles.nome}>{animalSorteado.nome}</Text>
            <Text style={styles.numero}>Número: {animalSorteado.numero}</Text>
            <Image
